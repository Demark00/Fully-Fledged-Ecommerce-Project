    ...
    <div>
      <div className="container mx-auto py-3 flex items-center justify-between">
        <div className="left w-[30%] flex items-center justify-between">
          ...
          <div className="address flex flex-col items-start space-y-1">
            <p className="poppins-bold tracking-wide text-lg flex items-center space-x-1 text-gray-800">
              <MdLocationOn className="text-xl"/>
              <span>Deliver to Priyanshu</span>
            </p>
            <p className="poppins-extralight text-sm text-gray-500 mx-7">
              Gurugram 122001
            </p>
          </div>
        </div>
        <div className="right w-[70%] flex items-center justify-end space-x-6">
          {/* Search Bar */}
          <div className="searchBar flex items-center bg-gray-100 rounded-md px-4 py-3 w-1/2 poppins-extralight">
          ...
          {/* Login Button */}
          <Button className="flex items-center space-x-2 bg-gray-100 hover:bg-gray-200 text-gray-700 px-4 py-2 rounded-md">
            <FiUser className="text-lg" />
            <span className="text-sm">Login</span>
          </Button>

          {/* Cart Button */}
          <Button className="relative flex items-center bg-gray-100 hover:bg-gray-200 text-gray-700 px-6 py-5 rounded-md">
            <FiShoppingCart className="text-xl" />
            <span className="text-lg ml-2">My Cart</span>
